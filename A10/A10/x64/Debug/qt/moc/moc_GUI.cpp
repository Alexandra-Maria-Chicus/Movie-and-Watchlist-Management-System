...
template <> constexpr inline auto GUI::qt_create_metaobjectdata<qt_meta_tag_ZN3GUIE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "switchToUserMode",
        "switchToWatchlistMode"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'switchToAdminMode'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'switchToUserMode'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'switchToWatchlistMode'
...
void GUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->switchToAdminMode(); break;
        case 1: _t->switchToUserMode(); break;
        case 2: _t->switchToWatchlistMode(); break;
        default: ;
        }
    }
    (void)_a;
