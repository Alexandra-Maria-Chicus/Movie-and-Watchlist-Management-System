...
template <> constexpr inline auto UserWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10UserWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'addMovieToWatchlist'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'seeWatchlist'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'deleteFromWatchlist'
...
void UserWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->seeMovies(); break;
        case 1: _t->showNextMovie(); break;
        case 2: _t->addMovieToWatchlist(); break;
        case 3: _t->seeWatchlist(); break;
        case 4: _t->deleteFromWatchlist(); break;
        case 5: _t->listWatchlist(); break;
        default: ;
        }
    }
    (void)_a;
